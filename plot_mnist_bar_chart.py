...
accuracy = [97.33, 91.49, 93.44, 90.34]
asr = [98.59, 14.39, 16.17, 97.28]
...
ax.set_title('Performance Comparison on MNIST', fontsize=14, pad=20, color='#333333', fontweight='bold')
ax.set_xticks(x)
...
plt.tight_layout()
output_path = 'd:/TUM/TDL/Robust-DPFL-main/Result/mnist_bar_chart.png'
