...
accuracy = [48.35, 29.81, 40.89, 10.01]
asr = [94.03, 25.67, 25.89, 99.49]
...
ax.set_title('Performance Comparison on CIFAR10', fontsize=14, pad=20, color='#333333', fontweight='bold')
ax.set_xticks(x)
...
plt.tight_layout()
output_path = 'd:/TUM/TDL/Robust-DPFL-main/Result/cifar10_bar_chart.png'
